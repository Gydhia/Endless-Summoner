...
//////////////////////////////////////////////////////////////////////////
// AEndlessSummonerCharacter

AEndlessSummonerCharacter::AEndlessSummonerCharacter()
{
...
void AEndlessSummonerCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AEndlessSummonerCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AEndlessSummonerCharacter::MoveRight);
...
void AEndlessSummonerCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AEndlessSummonerCharacter::MoveForward(float Value)
{
...
void AEndlessSummonerCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
